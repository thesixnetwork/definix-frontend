        ...
        <div className="pa-4 pt-3 bd-b">
          ...
          <div>
            <div className="flex align-center">
              <SpecialOutline color="primary" size="sm">Vote Now</SpecialOutline>&nbsp;
                    <SpecialOutlineCore color="success" size="sm">
                <img src={coreIcon} alt="coreIcon" />&nbsp;Core
                    </SpecialOutlineCore>
            </div>
            <Text fontSize="32px" bold lineHeight="1" marginTop="10px">Proposal Topic Proposal Topic Proposal Topic</Text>
          </div>
        </div>
        <Description>
          <Text>
