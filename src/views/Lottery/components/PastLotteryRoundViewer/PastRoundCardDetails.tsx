...
import { Heading, CardBody, CardFooter, DefinixRoundIcon, TicketRound } from 'uikit-dev'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} FINIX`)}
              Icon={DefinixRoundIcon}
            >
