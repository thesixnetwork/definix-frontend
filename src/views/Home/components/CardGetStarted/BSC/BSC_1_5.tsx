    ...
    <>
      ...
      <div>
        <Text fontSize="14px" className="mb-4">
          Binance smart chain is already added to your network. Now your wallet is ready to use on DEFINIX.
        </Text>
        <img src={img01} alt="" />
        <Text fontSize="14px" className="mb-4">
          Every transaction on DEFINIX on BSC require BNB to pay for a gas fee. Make sure you have enough BNB to pay for
          it.
        </Text>
        <Text fontSize="14px">
