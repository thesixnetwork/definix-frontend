    ...
    <>
      ...
      <div>
        <Text fontSize="14px" className="mb-4">
          To transfer FINIX to Kaikas. You need to bridge FINIX from BSC network to Klaytn network by using this link.
        </Text>
        ...
        <Text fontSize="14px">
          The bridge transaction from BSC network is including with 0.1% FINIX per transaction, the transaction fee will
          be deducted from your bridge amount automatically.
        </Text>
      </div>
    </>
  )
