      ...
      <StyledSlider {...settings}>
            ...
            <div className="pos-relative" style={{ zIndex: 1 }}>
              ...
              <div className="mt-6">
                <SpecialButton as="a" href="https://klaytn.definix.com/rebalancing">
                  <span>{t('Interesting, I want to invest')}</span>
                </SpecialButton>
              </div>
            </div>
          </StyledBannerLady>
        ...
        <div>
          <StyledBannerLongTerm className={className}>
            <div className="pos-relative" style={{ zIndex: 1 }}>
              <Heading className="mb-2" color="primary">
                {t('FINIX LONG-TERM STAKE WITH VOTING SYSTEM')}
              </Heading>
              <Text color="textSubtle" fontSize="12px">
                {t('New financial product from DEFINIX. It is the single-sided pool stake FINIX earn vFINIX.')}{' '}
              </Text>
              <Text bold fontSize="12px">
                {t(
                  'vFINIX can vote for rewarding fee return from a liquidity pool and discount fee conditioning for Rebalancing Farm.',
                )}
              </Text>
              <div className="mt-6">
