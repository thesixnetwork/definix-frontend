...
const NewExploreCard: React.FC<ExploreCardType> = ({ balance, rebalance = {}, onClickViewDetail, pendingReward }) => {
  ...
  const renderSash = () => {
    if (isMobile && rebalance.rebalance === 'New') {
      return <RebalanceSash type="listCard" />
    }

    if (rebalance.rebalance === 'New') {
