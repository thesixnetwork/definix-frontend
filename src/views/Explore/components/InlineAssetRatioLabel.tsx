...
const InlineAssetRatioLabel = ({ coin, column = false, className = '' }) => {
  const thisName = (() => {
  ...
  return (
    ...
    >
      ...
      {column || <VDivider mx="S_20" my="5px" />}
      <Text textStyle="R_16M" color="deepgrey" minWidth={column ? '100%' : '140px'} textAlign="right">
