...
const TradeStrategy: React.FC<TradeStrategyType> = ({ className = '' }) => {
  return (
    <Card className={`pa-4 ${className}`}>
      ...
      <Text fontSize="14px">- Selling the high performers and reinvesting that money into lower performers</Text>
      <Text fontSize="14px">- Funnelling new money into lower performers</Text>
    </Card>
  )
}
