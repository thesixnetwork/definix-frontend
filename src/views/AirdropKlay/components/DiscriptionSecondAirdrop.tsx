  ...
  return (
    <Collapsible handleTriggerClick={toggle} trigger={<TriggerElement isDown={open} />} open={open} disabled={disable}>
      <div>
        ...
        {/* <Text lineHeight="2">4.1 Airdrop is limited and distributed in a first come first serve method.</Text>
        <Text lineHeight="2">4.2. In case you use hardware wallet, please create new Kaikas wallet.</Text> */}
        <Text lineHeight="2">
          {t(
