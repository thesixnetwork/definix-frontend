...
export default function DiscriptionSecondAirdrop({ open = false, disable = false, toggle }: Props): ReactElement {
    ...
    return (
        <Collapsible handleTriggerClick={toggle} trigger={<TriggerElement isDown={open} />} open={open} disabled={disable}>
            <div>
                ...
                <Text lineHeight="2">
                    2. The airdrop will be automatically distributed 30 KLAY within 48 hours to the wallet address that used on <a style={{ color: "#0973B9" }} href="https://klaytn.definix.com">klaytn.definix.com</a> after supply liquidity and received LP token from <a style={{ color: "#0973B9" }} href="https://klaytn.definix.com">klaytn.definix.com</a>
                </Text>
                <Text lineHeight="2">
  ...
  Create Kaikas wallet
                ...
                <Text lineHeight="2">
                    5. All the airdrop activity is performed and triggered by the action of a smart contract. In case the user puts
                    in the account that the user doesn’t have a private key; the airdrop cannot be claimed and will be lost forever.
                </Text>
                <Text lineHeight="2">
