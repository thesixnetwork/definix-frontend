...
class DefinixPair extends Address {
  ...
  swap = (amount0Out, amount1Out, to) => {
    ...
    const amount0In =
      balance0 > this.reserve0.minus(amount0Out) ? balance0.minus(this.reserve0.minus(amount0Out)) : new BigNumber(0)
    const amount1In =
      balance1 > this.reserve1.minus(amount1Out) ? balance1.minus(this.reserve1.minus(amount1Out)) : new BigNumber(0)
