...
const rebalances: RebalanceConfig[] = [
...

  {
    ...
    icon: ['/images/vaults/img_rebalancing_top_coin_collector.png'],
    address: {
      1001: '',
...

  {
    ...
    icon: ['/images/vaults/img_rebalancing_three_musketeers.png'],
    address: {
      1001: '',
...

  {
    ...
    icon: ['/images/vaults/img_rebalancing_big_cap_one_plus.png'],
    address: {
...

  {
    ...
    icon: ['/images/vaults/img_rebalancing_finix_volatility.png'],
    address: {
