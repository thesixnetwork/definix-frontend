...
const farms: FarmConfig[] = [
   ...
   */
   {
    pid: 100,
    lpSymbol: 'FINGER-FINIX LP',
    lpAddresses: getLpNetwork(FINGER, FINIX),
    tokenSymbol: 'FINGER',
    tokenAddresses: FINGER,
    quoteTokenSymbol: QuoteToken.FINIX,
    quoteTokenAdresses: contracts.finix,
    firstToken: contracts.finger,
    secondToken: contracts.finix,
    firstSymbol: QuoteToken.FINGER,
    secondSymbol: QuoteToken.FINIX,
    tag: 'special',
  },
  {
    pid: 99,
    lpSymbol: 'FINGER-SIX LP',
    lpAddresses: getLpNetwork(FINGER, SIX),
    tokenSymbol: 'FINGER',
    tokenAddresses: FINGER,
   ...
   {
    pid: 98,
    lpSymbol: 'FINGER-KLAY LP',
    lpAddresses: getLpNetwork(FINGER, WKLAY),
    tokenSymbol: 'FINGER',
    tokenAddresses: FINGER,
   ...
   {
    pid: 97,
    lpSymbol: 'FINGER-KUSDT LP',
    lpAddresses: getLpNetwork(FINGER, KUSDT),
    tokenSymbol: 'FINGER',
    tokenAddresses: FINGER,
...
export const FINGER_FARMS = farms.filter(({ tokenSymbol, firstSymbol, secondSymbol }) => tokenSymbol === 'FINGER' || firstSymbol === QuoteToken.FINGER || secondSymbol === QuoteToken.FINGER)
