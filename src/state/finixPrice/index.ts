...
export const fetchFinixPrice = () => async (dispatch) => {
  ...
  const [
    ...
    [totalSixDefinixSixBusdPair, totalBusdDefinixSixBusdPair],
    [totalSixDefinixSixUsdtPair, totalUsdtDefinixSixUsdtPair],
  ...
  // const totalBusdDefinixSixBusdPair = 500000.0
  const sixBusdRatio = totalBusdDefinixSixBusdPair / totalSixDefinixSixBusdPair || 0
  // SIX-USDT
  // const totalSixDefinixSixUsdtPair = 12820512.82
  // const totalUsdtDefinixSixUsdtPair = 500000.0
  const sixUsdtRatio = totalUsdtDefinixSixUsdtPair / totalSixDefinixSixUsdtPair || 0
  // PANCAKE BNB-BUSD
  ...
  dispatch(
    setFinixPrice({
      ...
      totalUsdtDefinixFinixUsdtPair,
      totalFinixDefinixFinixBnbPair,
      totalBnbDefinixFinixBnbPair,
      totalSixDefinixSixBusdPair,
      totalSixDefinixSixUsdtPair,
      totalBusdDefinixSixBusdPair,
      totalUsdtDefinixSixUsdtPair,
