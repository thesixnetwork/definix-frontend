 ...
 * @see https://github.com/definixswap/gatsby-definix-api/commit/e811b67a43ccc41edd4a0fa1ee704b2f510aa0ba
 */
export const baseUrl = 'https://api.definixswap.com/api/v1'
