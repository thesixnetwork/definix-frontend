      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="flex justify-center" style={{ marginTop: "20px", marginBottom: "20px" }}>
            <span style={{ color: "white", marginRight: "10px" }}>Time Remaining:</span><span style={{ color: "yellow" }}>{countdown.minutes} min {countdown.seconds} sec</span>
          </div>
        </div>
        ...
        <div style={{ paddingBottom: "20px" }}>
          ...
          <div className="flex justify-center" style={{ fontSize: "10px" }}>Open Kakaotalk -&gt; Click the search bar -&gt; Log in by scanning the code</div>
          <br />
          <div className="flex justify-center" style={{ fontSize: "10px" }}>* Klip &gt; Code Scan (from side menu) can be used</div>
          <br />
